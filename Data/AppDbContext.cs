...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PC>().HasData(
            ...
            new PC { Id = 3, Name = "Budget Build", Weight = 7.1, Warranty = 12, CreatedAt = DateTime.Parse("2026-05-10T10:00:00"), Stock = 2 }
        );

        modelBuilder.Entity<PCComponent>().HasData(
            new PCComponent { PCId = 1, ComponentCode = "CPU0000001", Amount = 1 },
            new PCComponent { PCId = 1, ComponentCode = "GPU0000001", Amount = 1 },
            new PCComponent { PCId = 1, ComponentCode = "RAM0000001", Amount = 2 } // В Gaming Beast X стоит 2 плашки оперативки!
        );
    }
}